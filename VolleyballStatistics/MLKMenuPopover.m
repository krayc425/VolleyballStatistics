...
- (id)initWithFrame:(CGRect)frame menuItems:(NSArray *)aMenuItems
{
    ...
    if (self)
    {
        ...
        menuPointerView.tintColor = [Utilities getColor];
        menuPointerView.image = [[UIImage imageNamed:@"options_pointer"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate];
        ...
        menuItemsTableView.backgroundColor = [Utilities getColor];
        menuItemsTableView.tag = MENU_TABLE_VIEW_TAG;
        
        UIImageView *bgView = [[UIImageView alloc] initWithImage:[[UIImage imageNamed:@"Menu_PopOver_BG"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (cell == nil)
    {
        ...
        [cell setBackgroundColor:[Utilities getColor]];
    }
